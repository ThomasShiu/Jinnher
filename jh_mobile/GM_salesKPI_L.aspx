<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GM_salesKPI_L.aspx.cs" Inherits="GM_salesKPI_L" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>內銷業務出貨KPI</title>
                            ...
                            <td valign="top">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="SUM_AMT" HeaderText="金額(千)" 
                                            SortExpression="SUM_AMT" >
                                        <HeaderStyle BackColor="#CCCCCC" ForeColor="Black" />
                                        <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="SUM_NW" HeaderText="重量(噸)" SortExpression="SUM_NW" >
                                        <HeaderStyle BackColor="#CCCCCC" ForeColor="Black" />
                                        <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                    </Columns>
