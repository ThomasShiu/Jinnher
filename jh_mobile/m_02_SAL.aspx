<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m_02_SAL.aspx.cs" Inherits="m_02_SAL" %>
            ...
            <Columns>
               ...
               <asp:BoundField DataField="TTLAMT" DataFormatString="{0:N0}" 
                ...
                <asp:TemplateField HeaderText="執行">
                    <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"m_04_SAL.aspx?ym="+Eval("YM") %>' ImageUrl="~/images/search2.png">HyperLink</asp:HyperLink>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
            </Columns>
