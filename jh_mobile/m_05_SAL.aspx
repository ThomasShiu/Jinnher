<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m_05_SAL.aspx.cs" Inherits="m_05_SAL" %>
    ...
    <tr>
        <td>
            ...
            <asp:Chart ID="Chart1" runat="server" DataSourceID="DS_SALORDER" 
                Palette="SemiTransparent" Height="380px" Width="350px">
                <Series>
                    <asp:Series Name="Series1" ChartType="Pie" XValueMember="EMP_NAME" 
                ...
                <ChartAreas>
                    <asp:ChartArea Name="ChartArea1">
                        <Position Height="99" Width="99" X="0.1" Y="0.1" />
            ...
            <asp:SqlDataSource ID="DS_SALORDER" runat="server" 
                ...
                SELECT '' EMP_NAME,0 TTLAMT,0 TTLNW FROM DUAL"></asp:SqlDataSource>
    ...
    <tr>
        <td>
            ...
            <asp:GridView ID="GridView1" runat="server" DataSourceID="DS_SALORDER" 
                ...
                <Columns>
                    <asp:BoundField DataField="EMP_NAME" HeaderText="業務" 
                        SortExpression="EMP_NAME" />
                    <asp:BoundField DataField="TTLAMT" 
                        HeaderText="金額" SortExpression="TTLAMT" DataFormatString="{0:N0}" >
                    <ItemStyle HorizontalAlign="Right" />
                    </asp:BoundField>
                    <asp:BoundField DataField="TTLNW" HeaderText="重量" 
                        SortExpression="TTLNW" DataFormatString="{0:N0}">
                    <ItemStyle HorizontalAlign="Right" />
                    </asp:BoundField>
                </Columns>
     ...
     <tr>
        <td>     
            <asp:Chart ID="Chart2" runat="server" DataSourceID="DS_SALORDER" 
                Palette="Pastel" Height="380px" Width="350px">
                <Series>
