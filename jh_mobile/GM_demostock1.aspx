<%@ Page Title="內銷成品庫存BY種類" Language="C#" MasterPageFile="~/JH_MP.master" AutoEventWireup="true" CodeFile="GM_demostock1.aspx.cs" Inherits="GM_demostock1" %>
	...
	<div>
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="TTLWT" HeaderText="總噸" 
                ...
                <asp:TemplateField>
                <ItemTemplate>
                        <a href='<%#"desc_pic/"+ Eval("CAT")+".jpg" %>' rel="shadowbox" title="樣本" >
