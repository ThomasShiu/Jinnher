<%@ Page Title="外銷接單統計" Language="C#" MasterPageFile="~/JH_MP.master" AutoEventWireup="true" CodeFile="GM_exportorder.aspx.cs" Inherits="GM_exportorder" %>
        ...
        <tr>
          ...
          <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
           <ContentTemplate>
             ...
             <asp:TextBox ID="TB_sdate" runat="server" Height="19px" Width="70px"></asp:TextBox>
            ...
            <asp:TextBox ID="TB_edate" runat="server" Width="70px"></asp:TextBox>
            <asp:CalendarExtender ID="TB_edate_CalendarExtender" runat="server" 
                ...
                DaysModeTitleFormat="yyyy,MMMM" Format="yyyy/MM/dd" TodaysDateFormat="yyyy/MM/dd">
            </asp:CalendarExtender>
          ...
          <tr>
            ...
            <Columns>
                <asp:TemplateField HeaderText="種類" SortExpression="PDT_CAT_CAT">
                    ...
                    <ItemTemplate>
                        <a href='<%#"GM_showdescript.aspx?sn="+ Eval("PDT_CAT_CAT") %>' rel="shadowbox;height=200;width=300" title="樣品圖片" >
