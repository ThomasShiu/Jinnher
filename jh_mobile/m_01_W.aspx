<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m_01_W.aspx.cs" Inherits="m_01_W" %>
...
<body>
    ...
    <div>
		<ul data-role="listview" data-filter="true" data-filter-placeholder="Search items..." data-inset="true">
			<li><a href="m_06_W.aspx">0-盤元庫存</a></li>
            <li><a href="m_02_W.aspx?kind=1">1-球化產量</a></li>
            <li><a href="m_02_W.aspx?kind=2">2-酸洗產量</a></li>
            <li><a href="m_02_W.aspx?kind=3">3-伸線產量</a></li>
            <li><a href="m_04_W.aspx?kind=A">4-球化代工</a></li>
            <li><a href="m_04_W.aspx?kind=P">5-酸洗代工</a></li>
            <li><a href="m_07_W.aspx">6-成型廠線材庫存</a></li>
            <li><a href="m_08_W.aspx">7-盤元庫存彙總表</a></li>
		</ul>
	</div>
