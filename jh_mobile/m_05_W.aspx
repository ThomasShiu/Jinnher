<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m_05_W.aspx.cs" Inherits="m_05_W" %>
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SDS_wire" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="執行">
                    <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"m_06_W.aspx.aspx?workdate="+ Eval("WRK_DATE") %>' ImageUrl="~/images/search2.png">HyperLink</asp:HyperLink>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
            </Columns>
