...
public partial class GM_exportorder : System.Web.UI.Page
{
    ...
    protected void QueryCurry()
    {
        if ((TB_sdate.Text != "") & (TB_edate.Text != ""))
        {
            ...
            Sql_str += "        ,SUM(sk_get_po.amount(O.po_no,o.unit)/1000) CO_AMT  ";
    ...
    protected void QueryCust(string v_currency)
    {
        ...
        Sql_str += "        ,COUNT(*)    PO_COUNT  ";
        Sql_str += "        ,SUM(sk_get_po.amount(o.po_no,o.unit)/1000)     CO_AMT  ";
        Sql_str += "        ,SUM(the_total_order_weight_for(o.po_no)/1000)  CUS_WT  ";
        Sql_str += "   FROM ORDERS o  ";
        Sql_str += "  WHERE to_char(o.bk_date,'yyyy/mm/dd') BETWEEN '" + TB_sdate.Text + "' AND '" + TB_edate.Text + "'  ";
        Sql_str += "    AND o.inorext ='E'  ";
        Sql_str += "    AND o.eorl ='E'  ";
    ...
    protected void QueryCustAmt(string v_currency)
    {
        ...
        Sql_str = "SELECT ROUND(SUM(sk_get_po.amount(o.po_no,o.unit)*O.RATE/1000 ),0) AS TTLAMT,  ";
        Sql_str += "            ROUND(SUM(the_total_order_weight_for(o.po_no)/1000),0) AS TTLWT  ";
        Sql_str += "  FROM ORDERS o  ";
        Sql_str += " WHERE ( to_char(o.bk_date,'yyyy/mm/dd') BETWEEN  '" + TB_sdate.Text + "' AND '" + TB_edate.Text + "'    )  ";
        Sql_str += "AND o.inorext ='E'  ";
        Sql_str += "AND o.eorl ='E'   ";
    ...
    protected void QryOrdsum(string v_co_id)
    {
        ...
        Sql_str += ",the_total_order_weight_for(o.po_no)  PO_WT ";
        Sql_str += ",sk_get_po.amount(o.po_no,o.unit)     PO_AMT ";
        Sql_str += "  FROM ORDERS o ";
        Sql_str += "  WHERE to_char(o.bk_date,'yyyy/mm/dd')   BETWEEN '" + TB_sdate.Text + "' AND '" + TB_edate.Text + "'   ";
        Sql_str += "  AND o.inorext ='E' ";
        Sql_str += "  AND o.eorl ='E' ";
    ...
    protected void QueryTTLWT(string v_co_id)
    {
        ...
        Sql_str = " SELECT ROUND(SUM(the_total_order_weight_for(o.po_no))) AS  PO_WT  ";
        Sql_str += " FROM ORDERS o ";
        Sql_str += "WHERE to_char(o.bk_date,'yyyy/mm/dd')   BETWEEN '" + TB_sdate.Text + "' AND '" + TB_edate.Text + "' ";
        Sql_str += "  AND o.inorext ='E' ";
        Sql_str += "  AND o.eorl ='E' ";
    ...
    protected void QryOrder(string v_pono, string v_rate, string v_term)
    {
        ...
        Sql_str += "        SF_GET_PDTSIZE(A.pdt_cat_cat,A.pdt_dia,A.pdt_length,A.pdt_thread) AS PDT_SIZE , ";
        Sql_str += "        A.PDT_FIN_FIN_ID,A.PACK_CODE,A.PCS, ";
        Sql_str += "        SF_GET_STNDRD_WT(A.pdt_cat_cat,A.pdt_dia,A.pdt_length,A.pdt_thread) AS STD_WT, ";
        Sql_str += "        SF_GET_STNDRD_WT(A.pdt_cat_cat,A.pdt_dia,A.pdt_length,A.pdt_thread)*A.PCS AS TTL_WT, ";
        Sql_str += "        A.PRICE, ";
        Sql_str += "        CASE WHEN (sf_get_value('orders','unit','po_no',A.odr_po_no)='KG') THEN  ";
        Sql_str += "        ROUND((A.PRICE*to_number(" + v_rate + ")-" + v_s1 + "-" + v_s2 + " *SF_GET_VALUE('O_P_PARAM','VALUE','NAME','US_CURRENCY_RATE','STATUS','ACTIVE')/1000) * 1,2) ";
        Sql_str += "        ELSE ";
        Sql_str += "          ROUND((A.PRICE*to_number(" + v_rate + ")/SF_GET_STNDRD_WT(A.pdt_cat_cat,A.pdt_dia,A.pdt_length,A.pdt_thread)-" + v_s1 + "-" + v_s2 + "*SF_GET_VALUE('O_P_PARAM','VALUE','NAME','US_CURRENCY_RATE','STATUS','ACTIVE')/1000) * 1,2) ";
