<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m_03_W.aspx.cs" Inherits="m_03_W" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SDS_wire" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="執行" Visible="False">
                    <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"m_03_W.aspx.aspx?workdate="+ Eval("WRK_DATE") %>' ImageUrl="~/images/search2.png">HyperLink</asp:HyperLink>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
            </Columns>
        ...
        <asp:SqlDataSource ID="SDS_wire" runat="server" 
            ...
            ProviderName="<%$ ConnectionStrings:jheip.ProviderName %>" SelectCommand="SELECT '' PROC_NO,''  WRK_DATE,0 TTLWT
  FROM V_APC_JOB_FNSH   WHERE   TO_CHAR(WRK_DATE,'YYYY') ='2014'  AND   KIND = '2'  GROUP BY TO_CHAR(WRK_DATE,'YYYY/MM')  ORDER BY WRK_DATE"></asp:SqlDataSource>
