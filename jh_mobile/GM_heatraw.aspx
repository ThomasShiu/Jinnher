<%@ Page Title="待熱處理" Language="C#" MasterPageFile="~/JH_MP.master" AutoEventWireup="true" CodeFile="GM_heatraw.aspx.cs" Inherits="GM_heatraw" %>
     ...
     <tr>
       ...
       <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
        ...
        WaitMessageFont-Size="14pt" Height="" Width="" ShowReportBody="False" 
                   ShowToolBar="False">
        <LocalReport ReportPath="report\R_rawwt.rdlc">
            <DataSources>
                <rsweb:ReportDataSource DataSourceId="SqlDataSource1" Name="DS_heat_prd_runs" />
                <rsweb:ReportDataSource DataSourceId="SqlDataSource2" Name="DS_nw" />
            </DataSources>
        </LocalReport>
    </rsweb:ReportViewer>
