<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m_03_SAL.aspx.cs" Inherits="m_03_SAL" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SDS_wire" 
            ...
            <Columns>
                <asp:BoundField DataField="YM" HeaderText="年月" SortExpression="YM" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
               <asp:BoundField DataField="TTLAMT" DataFormatString="{0:N0}" 
                    HeaderText="金額" SortExpression="TTLAMT" >
                ...
                <asp:TemplateField HeaderText="執行">
                    <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"m_06_SAL.aspx?ym="+Eval("YM") %>' ImageUrl="~/images/search2.png">HyperLink</asp:HyperLink>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
            </Columns>
        ...
        <asp:SqlDataSource ID="SDS_wire" runat="server" 
            ...
            SelectCommand="SELECT '' YM,0 TTLAMT,0 TTLWT FROM DUAL"></asp:SqlDataSource>
