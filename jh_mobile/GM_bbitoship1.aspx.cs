...
public partial class GM_bbitoship1 : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            message2.Text = "";
            DS_bbitoship3.SelectCommand = Sql_str;
            ReportViewer2.LocalReport.ReportPath = "report/R_BBI_TO_SHIP1.rdlc";
            ReportViewer2.LocalReport.DataSources.Clear();
            ReportViewer2.LocalReport.DataSources.Add(new ReportDataSource("DS_bbitoship1", DS_bbitoship3));
