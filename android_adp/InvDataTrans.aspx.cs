...
public partial class InvDataTrans : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        pv_proc_emp  IN VARCHAR2
           */
            ...
            if ((Request.Params["pv_barcode1"] != null) & (Request.Params["pv_param"] != null) &
                (Request.Params["pv_loc"] != null) & (Request.Params["pv_proc_emp"] != null))
            {
    ...
    protected void Call_SP_PDAScan(string pv_barcode1, string pv_param, string pv_loc, string pv_proc_emp)
    {
               ...
               ConfigurationManager.ConnectionStrings[connStr].ConnectionString))
        {
            ...
            objCmd.CommandText = "SP_INV_SCAN"; 
