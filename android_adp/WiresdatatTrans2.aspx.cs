...
using System.Data;
//世宇斑馬，盤元領用、完工使用的服務
public partial class WiresdatatTrans2 : System.Web.UI.Page
{
                ...
                (Request.Params["type"] != null))
            {
                ...
                switch (v_type)
                {
                    ...
                    case "receive":
                        ...
                        //{
                        //    pv_class_no = "A";  //預設早班
                        //    Call_SP_finish2(pv_job_no, pv_coil_no, pd_proc_date, pv_proc_emp, pv_class_no);
                        //}
                        break;
    ...
    protected void Call_SP_finish(string pv_job_no, string pv_coil_no, string pd_proc_date, string pv_proc_emp, string pv_class_no)
    {
    ...
    //呼叫STORE PROCEDURE，工令完工 
    protected void Call_SP_finish2(string pv_job_no, string pv_coil_no, string pd_proc_date, string pv_proc_emp, string pv_class_no)
    {
        //pv_job_no     IN     VARCHAR2, -- 工令單號
        //pv_coil_no    IN     VARCHAR2, -- 卷號
        //pd_proc_date  IN     DATE,     -- 完工日期
